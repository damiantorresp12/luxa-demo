  ...
  window.LUXA = {
    ...
    i18n: {
      es: {
        ...
        'compare.add':              'Agregar a comparar',
        'compare.remove':           'Quitar de comparar',
        'compare.limit':            'Podés comparar hasta 2 productos a la vez.',
        'compare.hint.pickSecond':  'Elegí un segundo producto para ver la comparación.',
        'compare.hint.replace':     'Elegí otro producto para completar la comparación.',
        'compare.eyebrow':          'Herramienta',
        'compare.title':            'Comparar productos',
        'compare.sub':              'Las filas resaltadas en dorado son diferencias entre los dos productos.',
        'compare.backToBrowse':     'Volver a explorar',
        'compare.clearAll':         'Limpiar',
        'compare.viewDetail':       'Ver ficha',
        'compare.replace':          'Reemplazar',
        'compare.removeThis':       'Quitar producto',
        'compare.empty.title':      'Elegí un segundo producto',
        'compare.empty.sub':        'Agregá otra luminaria desde el catálogo, la ficha o los ambientes.',
        'compare.empty.cta':        'Ir al catálogo',
        'compare.legend.diff':      'Diferencia',
        'compare.legend.same':      'Coincide',
        ...
        'roomType.Office':       'Oficina',
        'lights.toggle':         'Cambiar luz',
        'lights.on':             'Luz · ON',
        'lights.off':            'Luz · OFF',
        'lightMap.toggle':       'Mapa de luz',
        'lightMap.average':      'lx promedio',
        'lightMap.low':          'poca luz',
        'lightMap.high':         'mucha luz',
        'lightMap.note':         'Calculado con la fotometría del fabricante. Valores indicativos.',
        'lightMap.optic':        'Óptica',
        'lightMap.option':       'Propuesta',
        'lightMap.finish':       'Terminación',
        'lightMap.scene':        'Encendido',
        'lightMap.ofRef':        '{pct} % de {lux} lx',
        'lightMap.at':           'a {h} m',
        'lightMap.workLine':     'A {h} m, altura de trabajo: {v} lx promedio',
        'lightMap.walls':        'Paredes: {v} lx promedio',
        'lightMap.min':          'mín',
        'lightMap.max':          'máx',
        'lightMap.even':         'pareja',
        'lightMap.spec':         'Especificación',
        'lightMap.totalW':       '{w} W en total',
        'photometry.title':      'Fotometría',
        'photometry.source':     'Datos del archivo fotométrico de {maker}',
        'photometry.sourceGeneric': 'Datos del archivo fotométrico del fabricante',
        'photometry.variant':    'Versión medida',
        'photometry.lumens':     'Flujo',
        'photometry.power':      'Potencia',
        'photometry.efficacy':   'Eficiencia',
        'photometry.beam':       'Apertura',
        'photometry.peak':       'Intensidad máxima',
        'photometry.down':       'Luz hacia abajo',
        'photometry.download':   'Descargar fotometría (IES)',
      ...
      en: {
        ...
        'compare.limit':            'You can compare up to 2 products at a time.',
        'compare.hint.pickSecond':  'Pick a second product to see the comparison.',
        'compare.hint.replace':     'Pick another product to complete the comparison.',
        'compare.eyebrow':          'Tool',
        'compare.title':            'Compare products',
        'compare.sub':              'Rows highlighted in brass mark differences between the two products.',
        'compare.backToBrowse':     'Back to browsing',
        'compare.clearAll':         'Clear',
        'compare.viewDetail':       'View sheet',
        'compare.replace':          'Replace',
        'compare.removeThis':       'Remove product',
        'compare.empty.title':      'Pick a second product',
        'compare.empty.sub':        'Add another luminaire from the catalog, the sheet or the ambients.',
        'compare.empty.cta':        'Go to catalog',
        'compare.legend.diff':      'Difference',
        ...
        'lights.toggle':         'Toggle lights',
        'lights.on':             'Lights · ON',
        'lights.off':            'Lights · OFF',
        'lightMap.toggle':       'Light map',
        'lightMap.average':      'lx average',
        'lightMap.low':          'low light',
        'lightMap.high':         'high light',
        'lightMap.note':         'Calculated from the manufacturer’s photometry. Indicative values.',
        'lightMap.optic':        'Optic',
        'lightMap.option':       'Lighting option',
        'lightMap.finish':       'Finish',
        'lightMap.scene':        'Lighting scene',
        'lightMap.ofRef':        '{pct}% of {lux} lx',
        'lightMap.at':           'at {h} m',
        'lightMap.workLine':     'At {h} m, working height: {v} lx average',
        'lightMap.walls':        'Walls: {v} lx average',
        'lightMap.min':          'min',
        'lightMap.max':          'max',
        'lightMap.even':         'evenness',
        'lightMap.spec':         'Specification',
        'lightMap.totalW':       '{w} W total',
        'photometry.title':      'Photometry',
        'photometry.source':     'From {maker}’s photometric file',
        'photometry.sourceGeneric': 'From the manufacturer’s photometric file',
        'photometry.variant':    'Measured version',
        'photometry.lumens':     'Output',
        'photometry.power':      'Power',
        'photometry.efficacy':   'Efficacy',
        'photometry.beam':       'Beam angle',
        'photometry.peak':       'Peak intensity',
        'photometry.down':       'Downward light',
        'photometry.download':   'Download photometry (IES)',
